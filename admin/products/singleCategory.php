...
<?php include(ROOT_PATH . "/app/includes/adminHeader.php"); ?>
  ...
  <div class="admin-wrapper">
    ...
    <a href="index.php" class="btn btn-big adding_managing">All Categories</a>
    ...
    <ul class="dropdown-menu">
        ...
        if($result){
            ...
            echo '
            <a href="?id='.$obj->id.'" class="btn btn-big fs-5" style="display: inherit;">'.$obj->category_name.'</a>
            ';
            $i++;
            }
        }
  ...
  if(isset($_SESSION)) {
    ...
    echo '
        ...
        echo '<h2> there is no products For Category</h2>';
    }
